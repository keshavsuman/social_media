...
import {adminDataTable} from "../../../../services/config/serviceroutes"
import{deleteUniversity,permissionList,editAdmin,updateAdminStatus,updateAdmin}from "../../../../services/userservices/user.admin.services"
    ...
    $(function () {
      ...
      $("#datatable").DataTable({
        ...
        columns: [
          ...
          { data: "email", title: "Email", email: "email" },
          { data: "mobile", title: "Mobile", mobile: "mobile" },
