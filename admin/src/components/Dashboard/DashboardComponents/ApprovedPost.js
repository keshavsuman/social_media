...
export default function ApprovedPost(props) {
  ...
  const _getPostsListData = async () => {
    let result = await postService.getPosts("approved", token);
      ...
      return (
        <tr key={index}>
          ...
          <td><div className="actions">
            {item.admin_approved ? 
            <span className="approved"><ion-icon name="checkmark-circle-outline"></ion-icon></span>:<span className="reject"><ion-icon name="close-circle-outline"></ion-icon></span>}</div></td>
        </tr>
      );
    });
  };
            ...
            <div className="content-header">
              <div className="container-fluid">
                <div className="row" style={{ marginBottom: "15px" }}>
                  ...
                  >
                    <h4 className="mx-4 text-dark">Approved Post List</h4>
                    <button
                      type="button"
